...
## 操作方法
十字キー:移動(左シフトも押すとランニング)<br>
スペースキー:ジャンプ<br>
Pキーまたは左クリック:攻撃、押しっぱなしまたは3秒以内に再度押すと連続攻撃<br>
Oキー:正面に壁展開(2秒で消える)<br>
Lキー:味方集合フラグONになり味方が集合、Player横の青いアイコン点灯でON<br>
マウス上下左右:カメラ上下左右に移動<br>
マウスホイール:ズームイン、ズームアウト<br><br>

## プログラム
### プログラムフォルダ
https://github.com/rune337/WindowsUnityGirl/tree/master/Assets/Scripts
...
## その他
### Web上で再生できない
当初webデータをMacでbuildしてアップロード、確認もMacで行っており、Windowsではweb上の確認を行っていませんでした。<br>
...
### カメラ
カメラのインスペクターのoutputにターゲットディスプレイが表示されず、カメラを増やしても切り替えができない事象が発生しています。<br>
